...
use sourcerenderer_core::graphics::{AddressMode, Filter, Format, Texture, TextureInfo, TextureShaderResourceView, TextureShaderResourceViewInfo};
...
impl TextureShaderResourceView for WebGLTextureShaderResourceView {
